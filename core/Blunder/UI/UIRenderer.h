...
namespace ui
{
    ...
    enum UITexture { UI_DISPLAY_T, UI_DISPLAY_F, UI_DROPDOWN_T, UI_DROPDOWN_F, UI_FOLDER_T, UI_FOLDER_F, UI_RENDER_T, UI_RENDER_F, UI_OBJECT_SYMBOL, UI_LIGHT_SYMBOL, UI_CAMERA_SYMBOL };
